    ...
    return (
        <BaakLayout title="Tambah Mata Kuliah">
            ...
            <div className="container mx-auto px-4 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-700 mb-2">Tambah Mata Kuliah Baru</h1>
                    <p className="text-gray-600">Isi form untuk menambah data mata kuliah baru</p>
                </div>
