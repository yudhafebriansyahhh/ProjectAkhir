...
export default function Create() {
    ...
    const handleSubmit = (event) => {
        ...
        post(route('baak.ruangan.store'));
    };

    return (
        <BaakLayout title="Tambah Ruangan">
            ...
            <div className="min-h-screen bg-slate-50 px-3 py-4 sm:px-4 sm:py-5 md:px-6 lg:px-8">
                <div className="mx-auto w-full max-w-4xl space-y-4 md:space-y-5">
                    <PageHeader title="Tambah Ruangan" description="Tambahkan master ruangan untuk dipakai pada jadwal kelas." />
