...
export default function Create({ prodiList, periodeList }) {
    ...
    // Auto-update tahun ajaran
    useEffect(() => {
        const year = getCurrentYear();
        const month = getCurrentMonth();

        if (month >= 8 || month === 1) {
            setData('tahun_ajaran', `${year}/${year + 1}`);
        } else {
            setData('tahun_ajaran', `${year - 1}/${year}`);
        }
    }, []);
        ...
        <BaakLayout>
            ...
            <div className="p-4 md:p-6">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-700 mt-2">Tambah Jadwal Pengisian KRS</h1>
                    <p className="text-sm text-gray-600 mt-1">Buat jadwal pengisian KRS baru untuk program studi</p>
                </div>
                                ...
                                >
                                    ...
                                    {prodiList.map((prodi) => (
                                        <option key={prodi.kode_prodi} value={prodi.kode_prodi}>
                                            {prodi.nama_prodi} ({prodi.jenjang}) - {prodi.fakultas.nama_fakultas}
                                        </option>
                                    ))}
                                </select>
                                {errors.kode_prodi && (
                        ...
                        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div className="flex gap-3">
                                ...
                                <div className="text-sm text-blue-800">
                                    <p className="font-medium mb-1">Tips Penggunaan Multi Semester:</p>
