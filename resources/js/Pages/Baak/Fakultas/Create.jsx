...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('baak.fakultas.store'));
    };

    return (
        <BaakLayout title="Tambah Fakultas">
            <Head title="Tambah Fakultas" />

            <div className="container mx-auto px-4 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-700 mb-2">Tambah Fakultas Baru</h1>
                    <p className="text-gray-600">Isi form untuk menambah data fakultas baru</p>
                </div>
