        ...
        if (window.Swal) {
            window.Swal.fire({
                ...
                if (result.isConfirmed) {
                    router.post(route('baak.mahasiswa.reset-password', mahasiswa.id_mahasiswa), {}, { preserveScroll: true });
                }
            });
        }
    };
        ...
        <BaakLayout title="Detail Mahasiswa">
            ...
            <div className="min-h-screen min-w-0 bg-slate-50 px-3 py-4 sm:px-4 sm:py-5 md:px-6 lg:px-8">
                <div className="mx-auto w-full min-w-0 max-w-[1440px] space-y-4 md:space-y-5">
                    <div className="min-w-0">
                        <Link href={route('baak.mahasiswa.index')} className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-blue-600 hover:text-blue-700">
                        ...
                        <PageHeader
                            ...
                            actionHref={route('baak.mahasiswa.edit', mahasiswa.id_mahasiswa)}
                    ...
                    <Card className="rounded-lg border-slate-200 shadow-sm">
                        <CardContent className="grid gap-5 p-4 sm:p-5 lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:items-center">
                            ...
                            <Button
                                type="button"
                                variant="outline"
                                className="w-full gap-2 border-amber-200 text-amber-700 hover:bg-amber-50 lg:w-auto"
