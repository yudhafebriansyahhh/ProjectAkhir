...
export default function Edit({ kelas, mata_kuliah, dosen }) {
        ...
        <BaakLayout title="Edit Kelas">
            ...
            <div className="p-4 md:p-6">
                ...
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-700 mt-2">Edit Data Kelas</h1>
                    <p className="text-sm text-gray-600 mt-1">Ubah data kelas perkuliahan yang sudah ada</p>
