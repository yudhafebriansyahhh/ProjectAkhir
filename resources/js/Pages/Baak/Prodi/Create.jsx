...
export default function Create({ fakultas }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('baak.prodi.store'));
    };

    return (
        <BaakLayout title="Tambah Program Studi">
            <Head title="Tambah Program Studi" />

            <div className="container mx-auto px-4 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-700 mb-2">Tambah Program Studi Baru</h1>
                    <p className="text-gray-600">Isi form untuk menambah data program studi baru</p>
                </div>
