...
export default function EditRps({ rps, matkul }) {

    const [formData, setFormData] = useState({
        kode_matkul: rps.kode_matkul || '',
        judul: rps.judul || '',
    });

    const [file, setFile] = useState(null);
    const [existingFile, setExistingFile] = useState(rps.file_path || null);
    ...
    const handleFileSelect = (selectedFile) => {
        if (selectedFile) {
            ...
            setExistingFile(null); // Clear existing file when new file selected
        }
    };
    ...
    const handleSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                formDataFinal.append('_method', 'PUT');
                
                if (file) {
                    formDataFinal.append('file_rps', file);
                }

                router.post(route('dosen.rps.update', rps.id_rps), formDataFinal, {
                    forceFormData: true,
                    onSuccess: () => {
                        Swal.fire('Berhasil!', 'RPS berhasil diperbarui.', 'success');
                    },
                });
            }
        });
    ...
    return (
        <DosenLayout title="Edit RPS">
            ...
            <div className="container mx-auto px-4 py-8 max-w-[600px] sm:max-w-full">
                ...
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-700 mb-2">Edit Rencana Pembelajaran Semester (RPS)</h1>
                    <p className="text-gray-600">
                        Edit RPS untuk mata kuliah yang Anda ampu.
                    </p>
                </div>
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {existingFile && !file && (
                                                <div className="mb-4 bg-blue-50 border border-blue-200 rounded-xl py-3 px-4">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center space-x-3">
                                                            <i className="fas fa-file-pdf text-blue-500 text-xl"></i>
                                                            <div>
                                                                <span className="text-blue-700 font-medium block">File saat ini</span>
                                                                <a 
