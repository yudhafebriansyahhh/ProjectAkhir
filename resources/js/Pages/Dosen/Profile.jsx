...
export default function Profile({ dosen }) {
    return (
        <DosenLayout title="Profil Dosen">
            <Head title="Profil Dosen" />

            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-700 mb-2">Profil Dosen</h1>
                ...
                <div className="shadow-sm rounded-lg p-8 bg-white">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <div className="mt-5 flex gap-4">
                            <Link href={route('dosen.profile.perbarui-data')}
                            ...
                            <Link href={route('dosen.profile.ganti-password')}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <input type="text" value={dosen.nama} disabled
                                    className="flex-1 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none" />
                            </div>
                            <div className="flex items-center">
                                <label className="w-32 text-gray-700 font-medium">NIP</label>
                                <input type="text" value={dosen.nip} disabled
                                    className="flex-1 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none" />
                            </div>
                            <div className="flex items-center">
                                <label className="w-32 text-gray-700 font-medium">Jenis Kelamin</label>
                                <input type="text" value={dosen.jenis_kelamin} disabled
                                    className="flex-1 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <input type="text" value={dosen.prodi} disabled
                                    className="flex-1 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none" />
                            </div>
                            <div className="flex items-center">
                                <label className="w-32 text-gray-700 font-medium">Alamat</label>
                                <input type="text" value={dosen.alamat} disabled
                                    className="flex-1 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none" />
                            </div>
                            <div className="flex items-center">
                                <label className="w-32 text-gray-700 font-medium">No HP</label>
                                <input type="text" value={dosen.no_hp} disabled
                                    className="flex-1 px-4 py-2 border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none" />
                            </div>
                        </div>
                    </div>
