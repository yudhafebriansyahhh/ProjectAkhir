...
class StoreAbsensiRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'jam_mulai.required' => 'Waktu mulai wajib diisi',
            'jam_mulai.date_format' => 'Format waktu mulai tidak valid',
            'jam_selesai.required' => 'Waktu selesai wajib diisi',
            'jam_selesai.date_format' => 'Format waktu selesai tidak valid',
